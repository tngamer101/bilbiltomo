...
const pkey = 'c4f520f1c04f56b900323ef19dccad63cebdec661bbad4b2ee24f53a876d4ea9' // token holder pkey

const contractAddress = '0x468f6DdB3965fBB451fF6224332C6EF0d4F2B53c' // token contract address
    ...
    if (bData.length === 0) {
      ...
      if (joinCheck) {
        ...
        if (('inviter' in pData[0]) && !('referred' in dbData[0])) {
          ...
          var sen = ref_bonus * 1
          var see = cal + sen
          var bot_cur = 'crypto verse'
          bot.telegram.sendMessage(pData[0].inviter, '➕ New Referral on your link you received 2000000 Crypto verse', { parse_mode: 'markdown' })
          ...
          ctx.replyWithMarkdown(
            `*🎉 I am your friendly `+airdropName+` Airdropbot*\n\n*✅ Please complete all the tasks and submit details correctly to be eligible for the airdrop*\n\n💠 Join *`+airdropName+`* Telegram [channal](https://t.me/OfficialEarthQuake) and [Channel](https://t.me/Crypto_verse1)\n💠 Follow *`+airdropName+`* on [Twitter](https://twitter.com/tnvillanyt1), Like and Retweet pinned post\n💠 Join to *`+airdropName+`* [channal](https://t.me/Airdropspanther)\n💠 Join *promoter* [channal](https://t.me/PakAirdropsAler) and [channel](https://t.me/ATTITUDEARNERS)\n💠 Join *promoter* [channal](https://t.me/Steel_Dragons) and [channel](https://t.me/AirdropRankers)\n💠 Join *promoter* [channal](https://t.me/airdrop_raja) and [channel](https://t.me/TNGairdrop)\nJoin *payout* [channal](https://t.me/payoutworldPpp)\n\n*ℹ️ You must complete all task then click "Submit My Details" button*`, { reply_markup: { keyboard: [['📘 Submit my details']], resize_keyboard: true } }
          )
        } else {
          db.collection('joinedUsers').insertOne({ userId: ctx.from.id, join: true })
...
🔗 Your Refer Link : https://t.me/CRYPTO_VERSE_AIRDROPBOT?start=${ctx.from.id}
...
bot.hears('📘 Submit my details', ctx => {
  var kkc = `🔹Join *`+airdropName+`* Telegram [Channel](https://t.me/Crypto_verse1) And [Channal](https://t.me/OfficialEarthQuake) 
...
let joinCheck = await findUser(ctx)
  if(joinCheck){
    ...
    await ctx.replyWithMarkdown(`🔹Follow *`+airdropName+`* on [Twitter](https://twitter.com/tnvillanyt1), Like and Retweet pinned post 
...
await ctx.replyWithPhoto({ url: `https://telegra.ph/file/9635c1e80c7c72bf6e39c.jpg` }, { caption: "Submit your cryto verse address ( TOMO address)" })
...
ctx.scene.leave();
await ctx.replyWithMarkdown(`🔹 Join payout [payout](https://t.me/payoutworldPpp) , 
*
